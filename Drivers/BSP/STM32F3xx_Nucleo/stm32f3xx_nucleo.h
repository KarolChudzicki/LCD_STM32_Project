 ...
 */
#define __STM32F3XX_NUCLEO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32F3XX_NUCLEO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32F3XX_NUCLEO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32F3XX_NUCLEO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
...
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_Exported_Types STM32F3XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */
...
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_LED STM32F3XX_NUCLEO LOW LEVEL LED
 * @{
 */
...
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_BUTTON STM32F3XX_NUCLEO LOW LEVEL BUTTON
 * @{
 */
/* Button state */
 ...
 * @}
 */
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_COM STM32F3XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STM32F3XX_NUCLEO_LOW_LEVEL_Exported_Functions STM32F3XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */
