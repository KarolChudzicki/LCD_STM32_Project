...
#ifndef STM32F3XX_NUCLEO_CONF_H
#define STM32F3XX_NUCLEO_CONF_H
...
/** @defgroup STM32F3XX_NUCLEO_CONFIG Config
  * @{
  */

/** @defgroup STM32F3XX_NUCLEO_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
